    ...
    >
      ...
      >
        ...
        <div class="py-4 text-left px-6">
          ...
          <ul class="flex flex-wrap mb-4">
            <li class="flex-auto text-center">
              <a
                ...
                :class="{
                  'hover:text-white text-white bg-blue-600': isLoginTab,
                  'hover:text-blue-600': isRegisterTab,
                }"
              >
                Login
              </a>
            ...
            <li class="flex-auto text-center">
              <a
                ...
                :class="{
                  'hover:text-white text-white bg-blue-600': isRegisterTab,
                  'hover:text-blue-600': isLoginTab,
                }"
              >
                Register
              </a>
          ...
          <!-- Registration Form -->
          <vee-form v-show="isRegisterTab" :validation-schema="schema">
            <!-- Name -->
            <div class="mb-3">
